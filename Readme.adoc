...
2. Asterix within certain terms, i.e. Reisende*r
German is a gendered language and to accommodate gender identities outside of the binary, male and female version of certain terms are seperated by an asterix. So for example, the word for traveler is Reisende (female) or Reisender (male). By including the asterix (Reisende*r), the word is inclusive to men, women and people outside the binary.
